  ...
  return (
    <div>
      ...
      <div className='relative bg-white text-black min-h-screen'>
        {/* Hero Section */}
        <div className='relative bg-[#50488D] flex flex-col items-center text-center text-white min-h-[400px] sm:min-h-[500px] md:min-h-[600px] lg:h-150 pt-12 sm:pt-16 md:pt-20 lg:pt-20 overflow-visible'>
          <h2 className='text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold leading-snug px-4 sm:px-8 md:px-12 lg:px-40 py-6 sm:py-8 lg:py-10'>
          A modern, intuitive cryptocurrency app that helps you <br className="hidden lg:block"/>track real-time prices,
      ...
      <div className='flex flex-col item-align-left px-4 sm:px-8 md:px-12 lg:px-40 py-12 sm:py-16 lg:py-20'>
        <h2 className='text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-semibold text-black text-align-left py-6 sm:py-8 lg:py-10 px-4 sm:px-8 md:px-12 lg:px-30'>Secondary Research</h2>
        <p className='text-base sm:text-lg lg:text-lg text-[#464646] text-align-left px-4 sm:px-8 md:px-12 lg:px-40'>
        To gain deeper insights into user behavior and expectations, I interviewed 2 participants via Google Meet — a mix of Intermediate <br className="hidden lg:block"/>crypto traders and beginners who recently started using crypto platforms.
        </p>
      </div>
