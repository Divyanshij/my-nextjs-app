      ...
      <div>
        <div className='bg-gradient-to-b from-[#61C3DB] to-[#FFFFFF] w-full min-h-[300px] sm:min-h-[350px] md:min-h-[400px] lg:h-400 border border- flex flex-col lg:flex-row justify-between items-center px-4 sm:px-8 md:px-12 lg:px-40 py-8 sm:py-12 md:py-16 lg:py-40 gap-6 lg:gap-0'>
          <div className='flex flex-col justify-left items-center px-4 sm:px-8 md:px-12 lg:px-40 py-4 sm:py-8 md:py-12 lg:py-40'>
            ...
            <Image src="/Images/abun before.png" alt="Abun Website Redesign" width={500} height={1000} className='w-full max-w-[250px] sm:max-w-[300px] md:max-w-[400px] lg:max-w-none h-auto lg:w-auto px-4 sm:px-6 md:px-8 lg:px-10 py-4 sm:py-6 md:py-8 lg:py-10' />
          </div>
          <div className='flex flex-col justify-end items-center px-2 sm:px-4 md:px-6 lg:px-10 py-2 sm:py-4 md:py-6 lg:py-10'>
            ...
            <Image src="/Images/abun after.png" alt="Abun Website Redesign" width={500} height={1000} className='w-full max-w-[250px] sm:max-w-[300px] md:max-w-[400px] lg:max-w-none h-auto lg:w-auto px-2 sm:px-3 md:px-4 lg:px-5 py-2 sm:py-3 md:py-4 lg:py-5' />
          </div>
        </div>
        <div className='flex flex-col lg:flex-row item-align-left gap-4 lg:gap-0 px-4 sm:px-8 md:px-12 lg:px-40 py-8 sm:py-12 md:py-16 lg:py-40'>
          <h2 className='text-xl sm:text-2xl lg:text-2xl font-semibold text-underline text-align-left px-4 sm:px-8 md:px-12 lg:px-30'>About Project</h2>
          <p className='text-base sm:text-lg lg:text-lg text-[#464646] text-align-left px-4 sm:px-8 md:px-12 lg:px-40'>Abun website helps to generate SEO-optimized blogs using AI . Redesigned the website to improve user engagement, visual hierarchy,
        ...
        <div className='flex flex-col lg:flex-row flex-wrap justify-between items-center gap-6 lg:gap-0 px-4 sm:px-8 md:px-12 lg:px-80 py-6 lg:py-0'>
          ...
          <h2 className='text-xl sm:text-2xl lg:text-2xl font-semibold text-underline text-center px-4 sm:px-6 md:px-8 lg:px-30 py-4 sm:py-6 md:py-8 lg:py-10'>Problem</h2>
